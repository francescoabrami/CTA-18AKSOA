...
\begin{enumerate}
	...
	\item[\textbf{-}] I DdB del modulo tende a $\infty$ dB ($\infty \unit{u_{nat}})$ $\Leftrightarrow$ c'è almeno un polo sull'asse immaginario del piano complesso.
		\begin{enumerate}
			...
			\item[\textbf{-}] Coppia di poli immaginari coniugati $\pm j\omega_0$.  
		\end{enumerate}
...
Infine, come vedremo più avanti, i diagrammi di Bode possono essere tracciati in ambiante \textsc{Matlab} utilizzando il relativo comando riportato di seguito.\\

Il comando \texttt{bode} in ambiente \textsc{Matlab} calcola e disegna il diagramma di Bode (modulo in dB e fase in gradi) della funzione di trasferimento o del modello dinamico che gli viene passato.\\
...
In \textsc{Matlab} si ottiene che:\\
...
\thispagestyle{empty}
\vspace*{7cm}
\section{Diagrammi polari e di Nyquist}
\vspace*{1.5cm}
